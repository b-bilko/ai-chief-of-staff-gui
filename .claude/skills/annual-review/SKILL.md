...
and what it was built from. An annual assembled from four quarterlies is the
richest file in this folder, and an interview run started on a quiet afternoon
should never overwrite it without the user saying so.
